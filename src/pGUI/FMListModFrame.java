...
public class FMListModFrame extends FMModFrame {
	 ...
	 * Create the frame.
	 */
	public FMListModFrame(int pID, FightManager pFM, MainFrame pMF) {
		super(pID, pFM, pMF);
	}
...
//--------------------------------------------------------------------------------------------------------
	...
	protected void setValues() {
		List vTemp;
		try {
			if ((id >= 0) && (rFM.haveFighterIDInList(id) == true)) {
				lFrameTitle_1.setText("für "+rFM.getCharacterOfFighter(id).getName());
